...
<head>
    ...
    <style type="text/css" data-premailer="ignore">
        ...
        * {
        ...
        /* What it does: Fixes webkit padding issue. Fix for Yahoo mails table alignment bug. Applies table-layout to the first 2 tables then removes for anything nested deeper. */
        table {
                                        ...
                                        <span data-key="1468267_greeting_text"
                                          ...
                                          Здравствуйте
                                                    ...
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 13px 0;"
                                                       align="center">Мы получили Ваш заказ.</p>
                                                </th>
                                            </tr>
                                                                    ...
                                                                    <tr>
                                                                        <th colspan="2" class="product-table-h3-wrapper"
                                                                            ...
                                                                            <h3 data-key="1468271_item"
                                                                                ...
                                                                                align="left">Заказанные товары</h3>
                                                                        </th>
                                                                    </tr>
                                                                    <!-- Bold 2 -->
                                                                    <!-- end Bold 2 -->
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" width="100%"
                                                        ...
                                                        <tr class="pricing-table-total-row">
                                                            <th class="table-title" data-key="1468271_total"
                                                                ...
                                                                align="left" bgcolor="#ffffff" valign="top">Общая
                                                                стоимость
                                                            </th>
                                                            <th class="table-text"
                                                                ...
                                                                valign="middle">{{ $order->calculateFullSum()}} руб.
                                                            </th>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                            ...
                                            <tr id="section-1468276" class="section closing_text">
                                                <th data-key="1468276_closing_text" class="text"
                                                    ...
                                                    align="center" bgcolor="#ffffff">
                                                    <p style="mso-line-height-rule: exactly; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; line-height: 26px; font-weight: 400; color: #666363; margin: 0;"
                                                       align="center">Если у Вас возникли проблемы напишите нам email:
                                                        deviceplumbingaz@gmail.com :)</p>
                                                </th>
                                            </tr>
                                                    ...
                                                    <table class="table_menu_bar" border="0" width="100%"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <th class="menu_bar_item last"
                                                                ...
                                                                align="center" bgcolor="#ffffff">
                                                                <a href="{{route('accounts.show',$user = Auth::id())}}"
                                                                   target="_blank"
                                                                   style="color: #bdbdbd; text-decoration: none !important; text-underline: none; word-wrap: break-word; text-align: center !important; font-family: -apple-system,BlinkMacSystemFont,'Segoe UI',Arial,'Karla'; font-size: 16px; font-weight: 400; line-height: 26px; text-transform: uppercase; letter-spacing: 1px;">
                                                                    Личный кабинет
                                                                </a>
                                                    ...
                                                    <table border="0" width="100%" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <th class="column_shop_block1 " width="100%"
                                                                ...
                                                                align="center" bgcolor="#ffffff">
                                                                <a href="deviceplumbing.ru" target="_blank"
                                                                   data-key="section_shop_block1"
                                                                   style="color: #ecba78; text-decoration: none !important; text-underline: none; font-size: 14px; font-weight: 400; text-transform: none;">deviceplumbing.ru</a>
                                                            </th>
                                                        </tr>
                                                        <!-- Store Website : END -->
                                                        </tbody>
